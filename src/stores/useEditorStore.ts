...
const AUTO_ICON_PRESETS: Record<AutoIconCategory, Icon[]> = {
  ...
  watchers: [
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-1', x: 484.80, y: 632.28 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-2', x: 759.06, y: 727.41 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-3', x: 822.18, y: 496.93 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-4', x: 468.74, y: 795.60 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-5', x: 261.21, y: 429.43 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-6', x: 47.21, y: 367.03 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-7', x: 566.95, y: 461.50 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-8', x: 356.73, y: 236.02 }, 'watchers'),
    buildAutoIcon('map', 'Watcher_mapicon_dota2_gameasset.png', { id: 'auto-watcher-9', x: 402.41, y: 86.37 }, 'watchers'),
