...
const NEW_VIDEO_KEY = 'yt_seen_v2';
const NEW_VIDEO_URL = 'https://www.youtube.com/watch?v=4d4r1Vlx7mY';
...
const handleDiscordClick = () => {
    posthog.capture('discord_link_clicked', { property: 'value' });
};
</script>
...
<template>
    <div class="social-links">
        ...
        <a href="https://discord.com/invite/7CWCUh4qgg" target="_blank" rel="noopener noreferrer" class="social-link"
            aria-label="Discord" @click="handleDiscordClick">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="social-icon">
                <path
